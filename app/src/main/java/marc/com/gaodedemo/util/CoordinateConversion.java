...
public class CoordinateConversion {
	...
	public double[] latLon2UTM_Doubles(double latitude,double longitue){
		LatLon2UTM c = new LatLon2UTM();
		return c.convertLatLonToUTM_Doubles(latitude,longitue);
	}
	...
	private class LatLon2UTM
	{
		...
		public double[] convertLatLonToUTM_Doubles(double latitude, double longitude)
		{
			validate(latitude, longitude);
			String UTM = "";
	...
	private class UTM2LatLon
	{
		...
		public double[] convertUTMToLatLong(String UTM)
		{
			...
			Log.i("TAG", "convertUTMToLatLong: "+latitude+","+longitude);
